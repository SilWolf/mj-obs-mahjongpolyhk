...
const MatchNameplate = ({ player }: { player: RealtimePlayer }) => {
  const lightenedColor = useMemo(
...
export default function DraftMatchNameplatePage() {
  ...
  return (
    <div className="print:w-[210mm] print:h-[297mm] overflow-hidden flex flex-col items-center justify-center">
      ...
      {[
        ...
        <div key={i} className="w-[170mm] h-[60mm] mx-auto">
